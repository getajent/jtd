// Dolle Project - Quantum Reality Script

class DolleProjectQuantumReality {
    constructor() {
        this.currentReality = 'dolle';
        this.isActive = false;
        this.quantumState = 'product';
        this.init();
    }
    ...
    activateReality() {
        this.isActive = true;
        console.log('Dolle Project Quantum Reality activated');
    ...
    setupNavEffects() {
        ...
        navLinks.forEach(link => {
            link.addEventListener('mouseenter', () => {
                ...
                link.style.color = 'var(--dolle-primary)';
            });
        ...
        navPortals.forEach(portal => {
            portal.addEventListener('mouseenter', () => {
                ...
                portal.style.borderColor = 'var(--dolle-primary)';
            });
            
            portal.addEventListener('mouseleave', () => {
                portal.style.transform = 'translateY(0)';
                portal.style.borderColor = 'rgba(255,74,107,0.3)';
            });
        });
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('Dolle Project Quantum Reality - Initializing...');
    
    // Initialize main reality system
    const dolleReality = new DolleProjectQuantumReality();
    
    // Setup value icons after reality is initialized
    dolleReality.setupValueIcons();
    ...
    console.log('Dolle Project Quantum Reality - Fully activated!');
});
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { DolleProjectQuantumReality, QuantumNavigation };
}
