// GreenInvest Project - Quantum Reality Script

class GreenInvestQuantumReality {
    constructor() {
        this.currentReality = 'greeninvest';
        this.isActive = false;
        this.quantumState = 'sustainable';
        this.init();
    }
    ...
    activateReality() {
        this.isActive = true;
        console.log('GreenInvest Quantum Reality activated');
    ...
    activatePortal(portal) {
        ...
        portal.style.boxShadow = '0 20px 40px rgba(0,200,81,0.2)';
    ...
    setupNavEffects() {
        ...
        navPortals.forEach(portal => {
            portal.addEventListener('mouseenter', () => {
                ...
                portal.style.borderColor = 'var(--green-primary)';
            });
            
            portal.addEventListener('mouseleave', () => {
                portal.style.transform = 'translateY(0)';
                portal.style.borderColor = 'rgba(0,200,81,0.3)';
            });
        });
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('GreenInvest Quantum Reality - Initializing...');
    
    // Initialize main reality system
    new GreenInvestQuantumReality();
    ...
    console.log('GreenInvest Quantum Reality - Fully activated!');
});
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { GreenInvestQuantumReality, QuantumNavigation };
}
